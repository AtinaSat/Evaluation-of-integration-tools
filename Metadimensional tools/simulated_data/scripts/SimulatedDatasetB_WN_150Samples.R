...
# simulating case B with noise large dataset
# Group3 of Data type 1 and Group2 of Data type 2 not distinguishable
...
for (i in 1:500){
  ...
  mirnasd <- miSds[ind[i]]
  # group1
  mus = c(mirnamean-mirnamean/2, mirnamean+mirnamean/2)
  sds = c(mirnasd, mirnasd+(mirnasd/10))
  mirnaSimulated[1:50,i] <- rnorm(n = 50, mean = mus[components], sd = sds[components]) + rnorm(n=50, mean =0, sd = 0.4)
  # group2
  mirnaSimulated[51:100,i] <- rnorm(n = 50, mean = mirnamean-(mirnamean/2), sd = mirnasd) + rnorm(n=50, mean =0, sd = 0.4)
  # group3
...
for (i in 1:500){
  ...
  # group2
  methSimulated[51:100,i] <- rnorm(n = 50, mean = methmean-(methmean/2), sd = methsd) + rnorm(n=50, mean =0, sd = 0.4)
  # group3
...
save(geSimulated, mirnaSimulated, methSimulated, sample_labels, file= "SimulatedCaseB_WN_150Samples.RData")
