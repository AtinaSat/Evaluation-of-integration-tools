...
# simulating case D with noise large dataset
...
for (i in 1:500){
  ...
  methSimulated[1:50,i] <- rnorm(n = 50, mean = mus[components], sd = sds[components]) + rnorm(n=50, mean =0, sd = 0.4)
  # group2
...
save(geSimulated, mirnaSimulated, methSimulated, sample_labels, file= "SimulatedCaseD_WN_150Samples.RData")
