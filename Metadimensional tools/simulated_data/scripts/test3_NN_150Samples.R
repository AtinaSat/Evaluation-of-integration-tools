...
# simulating case C no noise large dataset
...
geSimulated <- matrix(,nrow = 150, ncol = 500)
...
mirnaSimulated <- matrix(,nrow = 150, ncol = 500)
...
methSimulated <- matrix(,nrow = 150, ncol = 500)
...
save(geSimulated, mirnaSimulated, methSimulated, sample_labels, file= "SimulatedCaseC_NN_150Samples.RData")
