...
# simulating case A No Noise - large dataset
...
## for mixed signal
set.seed(999)
components <- sample(1:2,prob = c(0.5,0.5), size = 100, replace = T)
...
save(geSimulated, mirnaSimulated, methSimulated, sample_labels, file= "SimulatedCaseA_NN_150Samples.RData")
