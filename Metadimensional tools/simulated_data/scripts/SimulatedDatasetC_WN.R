...
# simulating case C with noise small dataset
...
for (i in 1:500){
  ...
  methSimulated[21:40,i] <- rnorm(n = 20, mean = mus[components], sd = sds[components]) + rnorm(n=20, mean =0, sd = 0.4)
  # group3
...
save(geSimulated, mirnaSimulated, methSimulated, sample_labels, file= "SimulatedCaseC_WN.RData")
