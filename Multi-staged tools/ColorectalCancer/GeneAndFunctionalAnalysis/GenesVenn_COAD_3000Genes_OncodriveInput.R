...
# save genes
write.table(CNAmetTotal, file = "/home/anita/Benchmarking/two_omics/ColonCancerCompleteDataAnalysis/CNAmet/CNAmet_UsingOncodriveCISInput/CNAmet_COAD_3000Genes_OncodriveInput.txt",
...
# save genes
write.table(iGCTotal, file = "/home/anita/Benchmarking/two_omics/ColonCancerCompleteDataAnalysis/iGC/iGC_UsingOncodriveCISInput/iGC_COAD_3000Genes_OncodriveInput.txt",
            row.names = F, quote = F, sep = "\t")
...
plrsGenes <- read.delim("/home/anita/Benchmarking/two_omics/ColonCancerCompleteDataAnalysis/plrs/PLRS_UsingOncodriveCISInput/PLRS_COAD_Results_OncodriveInput.tsv",
                        header = T, sep = "\t") # 12358
plrsSelected <- plrsGenes[plrsGenes$BH.adj.pval<0.05,]  # 8039
plrsGenes <- plrsSelected[order(plrsSelected$BH.adj.pval),]
plrsSelected <- plrsGenes
plrsTotal <- as.character(plrsSelected$Gene)

# save genes
write.table(plrsTotal, file = "/home/anita/Benchmarking/two_omics/ColonCancerCompleteDataAnalysis/plrs/PLRS_UsingOncodriveCISInput/PLRS_COAD_3000Genes_OncodriveInput.txt",
            row.names = F, quote = F, sep = "\t")
...
# save genes
write.table(OncoTotal, file = "/home/anita/Benchmarking/two_omics/ColonCancerCompleteDataAnalysis/OncodriveCIS/Oncodrive_COAD_AllOutputGenes.txt",
            row.names = F, quote = F, sep = "\t")
